...
from src.yolo_utils import TryExcept
from src.yolo_utils.dataloaders import exif_transpose, letterbox
from src.yolo_utils.general import (
    LOGGER,
    ROOT,
    Profile,
    check_requirements,
...
from src.yolo_utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from src.yolo_utils.downloads import is_url
